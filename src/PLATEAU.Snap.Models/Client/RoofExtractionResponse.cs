...
public class RoofExtractionResponse
{
    [Required]
    ...
    public RoofExtractionResponse()
    {
    }

    public RoofExtractionResponse(StatusType status, string? path, string? uri, Polygon? polygon)
    {
        Status = status;
        Path = path;
        Uri = uri;
